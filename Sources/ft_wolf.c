...
/*   Updated: 2018/06/01 16:34:46 by allallem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_get_texture(t_wolf3d *p)
{
	...
	p->tex_i[1].data = (unsigned char *)mlx_get_data_addr(p->tex_i[1].add, &p->tex_i[1].bpp, &p->tex_i[1].size_line, &p->tex_i[0].endian);
	p->tex_i[2].add = mlx_xpm_file_to_image(p->mlx, W3_T, &p->tex_i[2].wid, &p->tex_i[2].hei);
	p->tex_i[2].data = (unsigned char *)mlx_get_data_addr(p->tex_i[2].add, &p->tex_i[2].bpp, &p->tex_i[2].size_line, &p->tex_i[0].endian);
	p->tex_i[3].add = mlx_xpm_file_to_image(p->mlx, W4_T, &p->tex_i[3].wid, &p->tex_i[3].hei);
	p->tex_i[3].data = (unsigned char *)mlx_get_data_addr(p->tex_i[3].add, &p->tex_i[3].bpp, &p->tex_i[3].size_line, &p->tex_i[0].endian);
	p->tex_i[4].add = mlx_xpm_file_to_image(p->mlx, W5_T, &p->tex_i[4].wid, &p->tex_i[4].hei);
	p->tex_i[4].data = (unsigned char *)mlx_get_data_addr(p->tex_i[4].add, &p->tex_i[4].bpp, &p->tex_i[4].size_line, &p->tex_i[0].endian);
	p->tex_i[5].add = mlx_xpm_file_to_image(p->mlx, W6_T, &p->tex_i[5].wid, &p->tex_i[5].hei);
	p->tex_i[5].data = (unsigned char *)mlx_get_data_addr(p->tex_i[5].add, &p->tex_i[5].bpp, &p->tex_i[5].size_line, &p->tex_i[0].endian);
	p->tex_i[6].add = mlx_xpm_file_to_image(p->mlx, W7_T, &p->tex_i[6].wid, &p->tex_i[6].hei);
	p->tex_i[6].data = (unsigned char *)mlx_get_data_addr(p->tex_i[6].add, &p->tex_i[6].bpp, &p->tex_i[6].size_line, &p->tex_i[0].endian);
	p->tex_i[7].add = mlx_xpm_file_to_image(p->mlx, W8_T, &p->tex_i[7].wid, &p->tex_i[7].hei);
	p->tex_i[7].data = (unsigned char *)mlx_get_data_addr(p->tex_i[7].add, &p->tex_i[7].bpp, &p->tex_i[7].size_line, &p->tex_i[0].endian);
	p->tex_i[8].add = mlx_xpm_file_to_image(p->mlx, W9_T, &p->tex_i[8].wid, &p->tex_i[8].hei);
	p->tex_i[8].data = (unsigned char *)mlx_get_data_addr(p->tex_i[8].add, &p->tex_i[8].bpp, &p->tex_i[8].size_line, &p->tex_i[0].endian);
	p->tex_i[9].add = NULL;
}
